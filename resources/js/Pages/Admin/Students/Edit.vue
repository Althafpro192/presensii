...
<template>
    <AppLayout>
        ...
        <div class="mb-6 flex items-center gap-4">
            ...
            <div>
                <h1 class="text-[22px] font-medium text-slate-900 tracking-tight">Edit Siswa</h1>
                <p class="text-[13px] text-slate-500 mt-1">Perbarui data siswa {{ student.name }}</p>
            </div>
        </div>
